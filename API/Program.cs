...
builder.Services.AddScoped<IDataRepository<ActivityDbo>, DataRepository<ActivityDbo>>();
builder.Services.AddScoped<IDataRepository<DiscussionDbo>, DataRepository<DiscussionDbo>>();
